...
if __name__ == '__main__':
    ...
    #solutions = np.array([isl.get_population().champion_x for isl in islands])
    #solution = solutions[np.argmin([isl.get_population().champion_f for isl in islands])]
    #Tcrange = np.append(Tcrange, solutions[:,0])
    #Nurange = np.append(Nurange, solutions[:,1])
